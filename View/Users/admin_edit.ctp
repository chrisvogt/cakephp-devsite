        ...
        <div class="users form">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $this->Form->input('id', array('type' => 'number', 'class' => 'span12', 'disabled' => true)); ?>
                    </div><!-- .controls -->
                </div><!-- .control-group -->
                ...
                <div class="control-group">
                    <?php echo $this->Form->label('gravatar_email', 'Gravatar Email', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo $this->Form->input('gravatar_email', array('class' => 'span12')); ?>
                    </div><!-- .controls -->
                </div><!-- .control-group -->
                ...
                <div class="control-group">
                    <?php echo $this->Form->label('activation_key', 'Activation Key', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo $this->Form->input('activation_key', array('class' => 'span12', 'disabled' => true)); ?>
                    </div><!-- .controls -->
                </div><!-- .control-group -->

                <div class="control-group">
                    <?php echo $this->Form->label('projects', 'Projects', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo $this->Form->input('Project', array('class' => 'span12')); ?>
                    </div><!-- .controls -->
                </div><!-- .control-group -->
