            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td><?php echo h('img'); # h($user['User']['gravatar_email']);?>&nbsp;</td>
                        <td><?php echo ($user['User']['is_active'] ? h('Yes') : h('No')); ?>&nbsp;</td>
                        <td><?php echo h($this->Time->format($user['User']['last_seen'])); ?>&nbsp;</td>
                        <td><?php echo h($this->Time->format($user['User']['created'])); ?>&nbsp;</td>
                        <td class="actions">
